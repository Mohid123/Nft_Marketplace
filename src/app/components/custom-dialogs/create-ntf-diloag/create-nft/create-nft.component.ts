...
addNft() : void{
  ...
  addImage() : void {
    this.nftService.createNft = new NFT();
    this.createNft.controls.date.value;
    this.createNft.controls.selectedValue.value;
    this.createNft.controls.address.value;
    console.log(this.createNft); // returns value
    this.customDialogService.showCreateNFTStyleDialog();
      }
